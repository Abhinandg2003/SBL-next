...
function FAQItem({ item, isOpen, onToggle }) {
  ...
  return (
    <div className="border-b border-white/10">
      ...
      >
        <h3 className="text-xl font-medium text-white group-hover:text-[rgb(var(--primary-color))] transition-colors">
          {item.q}
        </h3>
        <svg
          className="w-6 h-6 flex-shrink-0 text-white group-hover:text-[rgb(var(--primary-color))] transition-all duration-300"
      ...
      >
        <div className="overflow-hidden" ref={contentRef}>
          <p className="text-white/60 pb-6 leading-relaxed">
            {item.a}
          </p>
        </div>
      </div>
...
export default function FAQdark() {
  ...
  return (
    <div className="pb-20 bg-[rgb(var(--secondary-color))]">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl md:text-5xl text-center text-white mb-10">
          Got{" "}
